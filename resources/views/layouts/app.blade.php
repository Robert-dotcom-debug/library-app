...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col">
    <nav class="bg-slate-900 text-white shadow-md">
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="{{ route('books.index') }}" class="hover:text-amber-300 transition">Catalogo</a>
                <a href="{{ route('categories.index') }}" class="hover:text-amber-300 transition">Categorias</a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="#" class="text-sm bg-amber-600 hover:bg-amber-700 px-3 py-1 rounded">
                    Registro
                </a>
            </div>
        </div>
    ...
    <footer class="bg-slate-900 text-slate-300 mt-12 py-6">
        <div class="container mx-auto px-4 text-center text-sm">
            &copy; {{ date('Y') }} Universidad Autonoma Tomas Frias - Ingenieria Informatica - INF560
        </div>
    </footer>
</body>
</html>
