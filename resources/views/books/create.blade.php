...
implementa en la Guía 7. 
        ...
        <form class="bg-white rounded shadow-sm p-6 space-y-4"> 
            ...
            <div> 
                <label class="block text-sm font-medium text-slate-700 mb
1">Título</label> 
...
py-2 bg-slate-100"> 
            ...
            <div> 
                <label class="block text-sm font-medium text-slate-700 mb
1">Categoría</label> 
                <select disabled class="w-full border border-slate-300 rounded px-3 py-2 
bg-slate-100"> 
...
py-2 bg-slate-100"> 
            ...
            <button type="button" disabled 
                    class="bg-slate-400 text-white px-4 py-2 rounded cursor
not-allowed"> 
